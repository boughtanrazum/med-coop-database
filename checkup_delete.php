...
$redirect_url = "checkup_manage.php";
...
if (isset($_GET['id'])) {
    ...
    if ($conn->connect_error) {
        ...
        try {
            $update_sql = "UPDATE Prescription SET Checkup = NULL WHERE Checkup = ?";
            ...
            $sql = "DELETE FROM Checkup WHERE IND = ?";
    ...
    $error_message = urlencode("Не указан ID осмотра!");
    $redirect_url .= "?error=" . $error_message;
}
